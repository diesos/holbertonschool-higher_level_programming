...
* [➤ Description](https://github.com/Diesos/holbertonschool-higher_level_programming/tree/main/python-hello_world#-description)
* [➤ Author’s disclaimer](https://github.com/Diesos/holbertonschool-higher_level_programming/tree/main/python-hello_world#-authors-disclaimer)
* [➤ Resources](https://github.com/Diesos/holbertonschool-higher_level_programming/tree/main/python-hello_world#-resources)
* [➤ Requirements](https://github.com/Diesos/holbertonschool-higher_level_programming/tree/main/python-hello_world#-requirements)
* [➤ More Info](https://github.com/Diesos/holbertonschool-higher_level_programming/tree/main/python-hello_world#-more-info)
* [➤ Tasks](https://github.com/Diesos/holbertonschool-higher_level_programming/tree/main/python-hello_world#-tasks)
* [➤ Author](https://github.com/Diesos/holbertonschool-higher_level_programming/tree/main/python-hello_world#-author)
...
```python
Diesos@ubuntu:~/py/0x00$ ./3-print_number.py
98 Battery street
Diesos@ubuntu:~/py/0x00$
```
</details>
...
```python
Diesos@ubuntu:~/py/0x00$ ./4-print_float.py
Float: 3.14
Diesos@ubuntu:~/py/0x00$
```
</details>
...
```python
Diesos@ubuntu:~/py/$ ./5-print_string.py 
...
```python
Diesos@ubuntu:~/py/$ ./6-concat.py
Welcome to Holberton School!
Diesos@ubuntu:~/py/$ wc -l 6-concat.py
5 6-concat.py
Diesos@ubuntu:~/py/$
```
</details>
...
```python
Diesos@ubuntu:~/py/$ ./7-edges.py
First 3 letters: Hol
Last 2 letters: on
Middle word: olberto
Diesos@ubuntu:~/py/$ wc -l 7-edges.py
8 7-edges.py
Diesos@ubuntu:~/py/$
```
</details>
...
```python
Diesos@ubuntu:~/py/$ ./8-concat_edges.py
object-oriented programming with Python
Diesos@ubuntu:~/py/$ wc -l 8-concat_edges.py
5 8-concat_edges.py
Diesos@ubuntu:~/py/$
```
</details>
...
```python
Diesos@ubuntu:~/py/$ ./9-easter_egg.py
