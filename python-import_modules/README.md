...
* [➤ Description](https://github.com/Diesos/holbertonschool-higher_level_programming/tree/main/python-import_modules#-description)
* [➤ Resources](https://github.com/Diesos/holbertonschool-higher_level_programming/tree/main/python-import_modules#-resources)
* [➤ General](https://github.com/Diesos/holbertonschool-higher_level_programming/tree/main/python-import_modules#-general)
* [➤ Requirements](https://github.com/Diesos/holbertonschool-higher_level_programming/tree/main/python-import_modules#-requirements)
* [➤ Tasks](https://github.com/Diesos/holbertonschool-higher_level_programming/tree/main/python-import_modules#-tasks)
* [➤ Author](https://github.com/Diesos/holbertonschool-higher_level_programming/tree/main/python-import_modules#-author)
...
Diesos@ubuntu:~/$ ./0-add.py
1 + 2 = 3
Diesos@ubuntu:~/$ cat 0-import_add.py
__import__("0-add")
Diesos@ubuntu:~/$ python3 0-import_add.py 
Diesos@ubuntu:~/$
```
</details>
...
```python
Diesos@ubuntu:~/$ cat calculator_1.py
#!/usr/bin/python3
def add(a, b):
    """My addition function
...
Diesos@ubuntu:~/$ ./1-calculation.py
10 + 5 = 15
10 - 5 = 5
10 * 5 = 50
10 / 5 = 2
...
```python
Diesos@ubuntu:~/$ ./2-args.py 
0 arguments.
Diesos@ubuntu:~/$ ./2-args.py Hello
1 argument:
1: Hello
Diesos@ubuntu:~/$ ./2-args.py Hello Welcome To The Best School
6 arguments:
1: Hello
2: Welcome
3: To
...
```python
Diesos@ubuntu:~/$ ./3-infinite_add.py
0
Diesos@ubuntu:~/$ ./3-infinite_add.py 79 10
89
Diesos@ubuntu:~/$ ./3-infinite_add.py 79 10 -40 -300 89 
-162
Diesos@ubuntu:~/$ 
...
```python
Diesos@ubuntu:~/$ curl -Lso "hidden_4.pyc" "https://github.com/hs-hq/0x02.py/raw/main/hidden_4.pyc"
Diesos@ubuntu:~/$ ./4-hidden_discovery.py | sort
my_secret_santa
print_hidden
print_school
Diesos@ubuntu:~/$
...
```python
Diesos@ubuntu:~/$ cat variable_load_5.py
#!/usr/bin/python3
a = 98
"""Simple variable
"""

Diesos@ubuntu:~/$ ./5-variable_load.py
98
Diesos@ubuntu:~/$
```
</details>
