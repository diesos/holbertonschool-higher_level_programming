...
* [➤ Description](https://github.com/Diesos/holbertonschool-higher_level_programming/tree/main/python-if_else_loops_functions#-description)
* [➤ Resources](https://github.com/Diesos/holbertonschool-higher_level_programming/tree/main/python-if_else_loops_functions#-resources)
* [➤ Genera](https://github.com/Diesos/holbertonschool-higher_level_programming/tree/main/python-if_else_loops_functions#-general)
* [➤ Requirements](https://github.com/Diesos/holbertonschool-higher_level_programming/tree/main/python-if_else_loops_functions#-requirements)
* [➤ Tasks](https://github.com/Diesos/holbertonschool-higher_level_programming/tree/main/python-if_else_loops_functions#-tasks)
* [➤ Author](https://github.com/Diesos/holbertonschool-higher_level_programming/tree/main/python-if_else_loops_functions#-author)
...
```python
Diesos@ubuntu:~/$ ./0-positive_or_negative.py 
-4 is negative
Diesos@ubuntu:~/$ ./0-positive_or_negative.py 
0 is zero
Diesos@ubuntu:~/$ ./0-positive_or_negative.py 
...
```python
Diesos@ubuntu:~/$ ./2-print_alphabet.py
abcdefghijklmnopqrstuvwxyzDiesos@ubuntu:~/$
```
</details>
...
```python
Diesos@ubuntu:~/$ ./3-print_alphabt.py
abcdfghijklmnoprstuvwxyzDiesos@ubuntu:~/$
```
</details>
...
```python
Diesos@ubuntu:~/$ ./5-print_comb2.py
...
```python
Diesos@ubuntu:~/$ ./6-print_comb3.py
...
Diesos@ubuntu:~/$ ./12-main.py | cat -e
